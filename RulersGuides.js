        ...
        showDetailedInfo = function () {
            ...
            for (i = 0; i < hGuides.length - 1; i = i + 1) {
                ...
                for (j; j < vGuides.length - 1; j = j + 1) {
                    ...
                    text = (vGuides[j + 1] - vGuides[j] - (j === 0 ? 42 : 0)) + ' x ' + (hGuides[i + 1] - hGuides[i] - (i === 0 ? 32 : 0));

                    infoData1.nodeValue = text;

                    text = (hGuides[i] - (i === 0 ? 0 : 32)) + ' : ' + (vGuides[j] - (j === 0 ? 0 : 42));
        ...
        if (
            ...
            dragdrop.set(guide, {
                ...
                onmove: function (elem) {
                    ...
                    pos = (elem.mode === 1) ? parseInt(elem.style.left, 10) : parseInt(elem.style.top, 10);
                    pos = parseInt(pos, 10);
